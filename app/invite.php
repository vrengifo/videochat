...
<TITLE>LiveVideoChat - Invite Friends</TITLE>
...
<TABLE WIDTH="100%"  BORDER="0" CELLSPACING="0" CELLPADDING="5">
  <TR>
    <TD><!-- InstanceBeginEditable name="Contenido" -->
      <P ALIGN="CENTER" CLASS="TTLinteriores">INVITE FRIENDS</P>
      <FORM NAME="form1" METHOD="post" ACTION="invite1.php">
        <TABLE BORDER="0" ALIGN="CENTER" CELLPADDING="5" CELLSPACING="0">
          <TR>
            <TD CLASS="form">Your name:</TD>
            <TD><INPUT NAME="yourname" TYPE="text" CLASS="fields" SIZE="30" value="<?=$yourname?>"></TD>
          </TR>
          <TR>
            <TD CLASS="form">Your E-mail:</TD>
            <TD><INPUT NAME="yourmail" TYPE="text" CLASS="fields" SIZE="30" value="<?=$yourmail?>"></TD>
          </TR>
          <TR>
            <TD CLASS="form">Your friend's name:</TD>
            <TD><INPUT NAME="friendname" TYPE="text" CLASS="fields" SIZE="30" value="<?=$friendname?>"></TD>
          </TR>
          <TR>
            <TD CLASS="form">Your friend's e-mail:</TD>
            <TD><INPUT NAME="friendmail" TYPE="text" CLASS="fields" SIZE="30" value="<?=$friendmail?>"></TD>
          </TR>
          <TR>
            <TD VALIGN="TOP" CLASS="form">Write your message </TD>
            <TD><TEXTAREA NAME="yourmsg" COLS="35" ROWS="6" CLASS="fields"><?=$yourmsg?></TEXTAREA></TD>
          </TR>
        </TABLE>
        <TABLE  BORDER="0" ALIGN="CENTER" CELLPADDING="15" CELLSPACING="0">
          <TR>
            <TD><DIV ALIGN="CENTER">
                <INPUT NAME="sendInvitation" TYPE="submit" CLASS="boton" VALUE="Send Invitation">
            </DIV></TD>
          </TR>
        </TABLE>
      </FORM>
