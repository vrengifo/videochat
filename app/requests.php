...
<TITLE>LiveVideoChat - Authorize Requests</TITLE>
...
<TABLE WIDTH="100%"  BORDER="0" CELLSPACING="0" CELLPADDING="5">
  <TR>
    <TD><!-- InstanceBeginEditable name="Contenido" -->
      <P ALIGN="CENTER" CLASS="TTLinteriores">AUTHORIZATION REQUESTS</P>
      <TABLE  BORDER="0" ALIGN="CENTER" CELLPADDING="5" CELLSPACING="0">
	  <?php
		  include_once("includes/main.php");
		  include_once("class/user.php");
		  $ouser=new user($conn);
		  $arr=$ouser->searchAuthReq($sUser);
		  if($arr==0)
		  {
		  ...
		  else
		  {
		    for($i=0;$i<count($arr);$i++)
			{
			  echo($ouser->authHtmlUser($arr[$i],$sUser));
			}
		  }
		?>
		<!--
          ...
          <TD><TABLE  BORDER="0" ALIGN="CENTER" CELLPADDING="3" CELLSPACING="0">
            <FORM>
              ...
              <TR>
                ...
                <TD CLASS="TxtDescripciones">Please let me chat with you, i'll be waiting your reply </TD>
              </TR>
              <TR>
                <TD>&nbsp;</TD>
                <TD>&nbsp;</TD>
                <TD><TABLE WIDTH="80%"  BORDER="0" ALIGN="CENTER" CELLPADDING="0" CELLSPACING="0">
                  <TR>
                    <TD WIDTH="50%"><A HREF="confirmation_request.html" CLASS="user"><IMG SRC="images/visto.gif" WIDTH="16" HEIGHT="13" BORDER="0"> Allow user</A></TD>
                    <TD WIDTH="50%"><A HREF="confirmation_request.html" CLASS="user"><IMG SRC="images/equis.gif" WIDTH="16" HEIGHT="15" BORDER="0"> Deny User</A></TD>
                  </TR>
                </TABLE></TD>
              </TR>
            </FORM>
