...
<TITLE>LiveVideoChat - Request Confirmation</TITLE>
...
<TABLE WIDTH="100%"  BORDER="0" CELLSPACING="0" CELLPADDING="5">
  <TR>
    <TD><!-- InstanceBeginEditable name="Contenido" -->
      <P ALIGN="CENTER" CLASS="TTLinteriores">&nbsp;</P>
      <P ALIGN="CENTER" CLASS="TTLinteriores">CONFIRMATION MESSAGE</P>
      <P ALIGN="CENTER" CLASS="LinkWhosonline">
	  <?php
	    if(isset($error))
		...
		{  
	  ?>
	    Your buddy was succesfully added, <A HREF="favorites.php" CLASS="LinkWhosonline">click here</A> to access your favorites.
	  <?php
	    }
	  ?>	
	  </P>
      <P ALIGN="CENTER" CLASS="LinkWhosonline">&nbsp;</P>
